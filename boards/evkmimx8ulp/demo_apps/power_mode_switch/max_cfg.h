...
/* MAX Configurations */
#define MAX_CFG_MODE                (kMAX_MultiLedMode)
...
#define MAX_CFG_SAMPLING_TIME       (9U)
 ...
 */
#define MAX_CFG_TOTAL_SAMPLES               ((MAX_CFG_SR_2_SMP_PER_SEC(MAX_CFG_SAMPLERATE) >> MAX_CFG_SMP_AVE) * MAX_CFG_SAMPLING_TIME)
