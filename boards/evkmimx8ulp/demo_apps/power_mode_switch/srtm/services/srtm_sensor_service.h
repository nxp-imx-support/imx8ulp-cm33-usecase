...
/* The enum list should match sensor types in kernel rpmsg_iio_pedometer driver */
typedef enum
{
    SRTM_SensorTypePedometer        = 0x00U,
    SRTM_SensorTypeTilt             = 0x01U,
    SRTM_SensorTypeHeartRate        = 0x02U,
    SRTM_SensorTypeSpO2             = 0x03U,
    SRTM_SensorTypeTemperature      = 0x04U,
    SRTM_SensorTypeTotalNum,
} srtm_sensor_type_t;
