...
void SRTM_SensorService_Reset(srtm_service_t service, srtm_peercore_t core)
{
    ...
    handle->sensor->enableStateDetector(handle->sensor, SRTM_SensorTypeHeartRate,   0, false);
    handle->sensor->enableStateDetector(handle->sensor, SRTM_SensorTypeSpO2,        0, false);
    handle->sensor->enableStateDetector(handle->sensor, SRTM_SensorTypeTemperature, 0, false);
    handle->sensor->enableDataReport(handle->sensor,    SRTM_SensorTypeHeartRate,   0, false);
    handle->sensor->enableDataReport(handle->sensor,    SRTM_SensorTypeSpO2,        0, false);
    handle->sensor->enableDataReport(handle->sensor,    SRTM_SensorTypeTemperature, 0, false);
