 ...
 *
 * @param base EPDC base pointer
 * @param waveform Waveform mode
 */
static inline void EPDC_ConfigureWaveform(EPDC_Type *base, uint8_t waveform)
{
    base->UPD_CTRL.RW = (base->UPD_CTRL.RW & ~EPDC_UPD_CTRL_WAVEFORM_MODE_MASK) | EPDC_UPD_CTRL_WAVEFORM_MODE(waveform);
}
