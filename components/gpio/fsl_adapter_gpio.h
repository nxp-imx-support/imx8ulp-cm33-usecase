...
/*! @brief The interrupt generation condition of GPIO adapter. */
typedef enum _hal_gpio_sel
{
    kHAL_GpioInt0 = 0x00U, /*!< kRGPIO_InterruptOutput0 */
    kHAL_GpioInt1 = 0x01U, /*!< kRGPIO_InterruptOutput1 */
    kHAL_GpioInt2 = 0x02U, /*!< kRGPIO_InterruptOutput2 */
    kHAL_GpioInt3 = 0x03U, /*!< kRGPIO_InterruptOutput3 */
} hal_gpio_sel_t;
...
/*!
 * @brief interrupt handle for gpio.
 *
 */
